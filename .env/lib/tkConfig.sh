...
# installed.
TK_PREFIX='/Users/ryanalcantara/Buff Drive/Research/Treadmetrix_Drift_Project/code_repo/dryft/.env'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/ryanalcantara/Buff Drive/Research/Treadmetrix_Drift_Project/code_repo/dryft/.env'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/local/miniconda/conda-bld/tk_1568213757927/work/tk8.6.9/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/ryanalcantara/Buff Drive/Research/Treadmetrix_Drift_Project/code_repo/dryft/.env/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/ryanalcantara/Buff Drive/Research/Treadmetrix_Drift_Project/code_repo/dryft/.env/include'
...
# compiled.
TK_SRC_DIR='/usr/local/miniconda/conda-bld/tk_1568213757927/work/tk8.6.9'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/usr/local/miniconda/conda-bld/tk_1568213757927/work/tk8.6.9/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/ryanalcantara/Buff Drive/Research/Treadmetrix_Drift_Project/code_repo/dryft/.env/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/usr/local/miniconda/conda-bld/tk_1568213757927/work/tk8.6.9/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Users/ryanalcantara/Buff Drive/Research/Treadmetrix_Drift_Project/code_repo/dryft/.env/lib/libtkstub8.6.a'
