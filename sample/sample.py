...
trim = dr.trimaerial(GRF_filt[:,2], step_begin, step_end)
aerial_means = dr.meanaerialforce(GRF_filt[:,2], step_begin, step_end, trim ) #aerial_means will be same width as GRF_filt
dr.plotaerial(GRF_filt[:,2], aerial_means, aerial_begin_all, aerial_end_all, trim) #aerial_means and GRF_filt must be (n,) arrays
